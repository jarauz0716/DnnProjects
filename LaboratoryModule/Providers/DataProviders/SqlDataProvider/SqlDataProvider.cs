...
namespace Jar.Dnn.LaboratoryModule.Data
{
    ...
    public class SqlDataProvider : DataProvider
    {
        ...
        private const string ModuleQualifier = "LaboratoryModule_";
        ...
        public override void SetDoctor(string PersonalId, string Gender, DateTime Birthday, string FirstName, string SecondName, string LastName, string SecondLastName, string DrCode, string DrRegistry, string DrSpecialty, string Phone, string CellPhone, string Whatsapp, string Email, string Address, int Id = 0)
        {
            string command = "VM_SP_Set_Doctor";
            System.Data.SqlClient.SqlParameter[] parameters = new System.Data.SqlClient.SqlParameter[16];
            ...
            try
            {
                ...
                parameters[7] = new System.Data.SqlClient.SqlParameter("@DrCode", DrCode)
                {
                    SqlDbType = System.Data.SqlDbType.VarChar,
                    Size = 10
                };
                parameters[8] = new System.Data.SqlClient.SqlParameter("@DrRegistry", DrRegistry)
                {
                    SqlDbType = System.Data.SqlDbType.VarChar,
                    Size = 10
                };
                parameters[9] = new System.Data.SqlClient.SqlParameter("@Specialty", DrSpecialty)
                {
                    SqlDbType = System.Data.SqlDbType.VarChar,
                    Size = 50
                };
                parameters[10] = new System.Data.SqlClient.SqlParameter("@Birthday", Birthday)
                {
                    SqlDbType = System.Data.SqlDbType.DateTime,
                    Direction = ParameterDirection.Input
                };
                parameters[11] = new System.Data.SqlClient.SqlParameter("@Address", Address)
                {
                    SqlDbType = System.Data.SqlDbType.VarChar,
                    Size = 250
                };
                parameters[12] = new System.Data.SqlClient.SqlParameter("@Phone", Phone)
                {
                    SqlDbType = System.Data.SqlDbType.VarChar,
                    Size = 10
                };
                parameters[13] = new System.Data.SqlClient.SqlParameter("@CellPhone", CellPhone)
                {
                    SqlDbType = System.Data.SqlDbType.VarChar,
                    Size = 10
                };
                parameters[14] = new System.Data.SqlClient.SqlParameter("@Whatsapp", Whatsapp)
                {
                    SqlDbType = System.Data.SqlDbType.VarChar,
                    Size = 10
                };
                parameters[15] = new System.Data.SqlClient.SqlParameter("@Email", Email)
                {
                    SqlDbType = System.Data.SqlDbType.VarChar,
                    Size = 50
                };
            ...
            {
                throw new Exception("Error al ejecutar la función SqlDataProvider.SetDoctor, " + ex.Message, ex);
            }
        }
